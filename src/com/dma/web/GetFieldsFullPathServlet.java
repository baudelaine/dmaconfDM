 ...
 */
@WebServlet(name = "GetFieldsFullPath", urlPatterns = { "/GetFieldsFullPath" })
public class GetFieldsFullPathServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetFieldsFullPathServlet() {
        super();
