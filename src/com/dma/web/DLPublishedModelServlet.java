 ...
 */
@WebServlet(name = "DLPublishedModel", urlPatterns = { "/DLPublishedModel" })
public class DLPublishedModelServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public DLPublishedModelServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Path zip = (Path) request.getServletContext().getAttribute("publishedModelPath");
