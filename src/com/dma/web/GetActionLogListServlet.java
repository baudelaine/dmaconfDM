 ...
 */
@WebServlet(name = "GetActionLogList", urlPatterns = { "/GetActionLogList" })
public class GetActionLogListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetActionLogListServlet() {
        super();
