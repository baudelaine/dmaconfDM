 ...
 */
@WebServlet(name = "GetFilterTarget", urlPatterns = { "/GetFilterTarget" })
public class GetFilterTargetServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetFilterTargetServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(parms != null) {
				...
				Map<String, QuerySubject> qss = (Map<String, QuerySubject>) Tools.fromJSON((String) parms.get("qss"), new TypeReference<Map<String, QuerySubject>>(){}); 
				String selectedQs = (String) parms.get("selectedQs");
...
//						String table = qs.getValue().getTable_name();
						...
						if(qs.getValue()._id.equalsIgnoreCase(selectedQs)) {
							datas.put("[FINAL].[" + qsFinalName + "]", selectedQs);
						}
						...
						recurse0(qsAlias, gDirName, qsFinalName, qSleftType, qss, recurseCount, selectedQs, datas);
	...
	protected void recurse0(String qsAlias, String gDirName, String qsFinalName, String qSleftType,
			Map<String, QuerySubject> qss, Map<String, Integer> recurseCount, String selectedQs, Map<String, String> datas) {
		// TODO Auto-generated method stub
