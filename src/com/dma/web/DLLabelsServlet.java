 ...
 */
@WebServlet(name = "DLLabels", urlPatterns = { "/DLLabels" })
public class DLLabelsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public DLLabelsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(Files.exists(zip)) {
				...
				response.addHeader("Content-Disposition", "attachment; filename=labels.zip");
