 ...
 */
@WebServlet(name = "DLWks", urlPatterns = { "/DLWks" })
public class DLWksServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(Files.exists(zip)) {
				...
				response.addHeader("Content-Disposition", "attachment; filename=workspace.zip");
